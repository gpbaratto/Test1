sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.approvePurchaseOrders.controller.D3_1461160697744", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.approvePurchaseOrders.view.D3_1461160697744", this);
			this._bInit = false;
		},
		...
		_onSearchFieldLiveChange: function (oEvent) {
			var sControlId = "sap_m_Dialog_2-content-sap_m_StandardList-1527513930866";
			...
			return new Promise(function (fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("Department", sap.ui.model.FilterOperator.Contains, sQuery));
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "sap_m_Dialog_2-content-sap_m_StandardList-1527513930866",
				"groups": ["items"]
			}];
