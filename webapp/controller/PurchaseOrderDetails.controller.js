sap.ui.define(["sap/ui/core/mvc/Controller",
	"sap/m/MessageBox",
	"./D0_1461159223186", "./D4_1461161907434", "./D3_1461160697744", "./Popover1", "./Popover2",
	"./utilities",
	"sap/ui/core/routing/History"
], function (BaseController, MessageBox, D0_1461159223186, D4_1461161907434, D3_1461160697744, Popover1, Popover2, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.approvePurchaseOrders.controller.PurchaseOrderDetails", {
		handleRouteMatched: function (oEvent) {
			...
			this.sContext = "PurchaseContractHeaderSet('4500025567')";
		...
		_onButtonPress1: function () {
			...
			var sDialogName = "D4_1461161907434";
			this.mDialogs = this.mDialogs || {};
			var oDialog = this.mDialogs[sDialogName];

			if (!oDialog) {
				oDialog = new D4_1461161907434(this.getView());
				this.mDialogs[sDialogName] = oDialog;
		...
		_onButtonPress2: function () {
			...
			var sDialogName = "D3_1461160697744";
			this.mDialogs = this.mDialogs || {};
			var oDialog = this.mDialogs[sDialogName];

			if (!oDialog) {
				oDialog = new D3_1461160697744(this.getView());
				this.mDialogs[sDialogName] = oDialog;
